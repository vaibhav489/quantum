            ...
            <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                <div class="sm:col-span-2">
                    <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
                        ...
                        <span class="ml-2 text-xl font-bold tracking-wide text-gray-900 dark:text-gray-100 uppercase">Quantum IT innovation</span>
                    </a>
                    <div class="mt-6 lg:max-w-sm">
                        ...
                        <p class="mt-4 text-sm text-gray-900 dark:text-gray-100">
                            Quantum IT innovation is a modern platform that connects travelers with hosts offering unique stays across the country. Whether you're looking for a cozy room, an entire home, or a peaceful retreat, Quantum IT innovation helps you find the perfect place to stay.
                        </p>
                    </div>
                </div>
